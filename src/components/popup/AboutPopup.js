        ...
        <div className="left">
          <div className="left_inner">
            ...
            <div className="edrea_tm_button full">
              <a href="img/about/1.png" download>
                Download CV
              </a>
            </div>
          </div>
        ...
        <div className="right">
          <div className="right_inner">
            <div className="biography">
              ...
              <div className="text">
                <p>
                  Hello everybody! My name is <span>{aboutData.firstName + " " +aboutData.lastName}.</span> I am a
                  Web Developer, and {`I'm`} very passionate and dedicated to
                  my work. With 7+ years experience as a professional web
